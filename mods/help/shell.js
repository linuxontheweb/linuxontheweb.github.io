...
ls:`Prints a simple listing of directories, the sizes of files or the values of symbolic links (if the link points to a directory, and the link name is followed by a forward slash, the directory will be listed instead).
Options:
	-a, --all
		include dotfiles
	-R, --recursive
...
symln:`Creates a symbolic link to a possibly non-existent target (file or directory)
Usage: symln TARGET LINK_NAME`,
ln:`Creates a hard link to a target file, which must exist and must be a "regular" file
