...
//!!! This file is hardlinked to $NODE_PATH/imapflow/lib/imap-flow.js !!!
//!!! Caution: editing this file will change the behaviour of the imapflow module !!!

/*10/12/24: NoConnection crash due to IDLE command«

@CKUEOPMNT: Was getting this error yesterday immediately after the connection
was automatically closed due to inactivity, but I couldn't tell which command
was being run to cause this error (perhaps related to "auto idling"?). I can't
replicate this by just doing "imapcon" from the LOTW terminal, and then doing
nothing. 

Error: Connection not available
    at ImapFlow.run (/usr/local/home/.node/node_modules/imapflow/lib/imap-flow.js:2856:27)
    at ImapFlow.idle (/usr/local/home/.node/node_modules/imapflow/lib/imap-flow.js:1795:31)
    at /usr/local/home/.node/node_modules/imapflow/lib/imap-flow.js:661:42
    at process.processTicksAndRejections (node:internal/process/task_queues:105:5)
Emitted 'error' event on ImapFlow instance at:
    at ImapFlow.emitError (/usr/local/home/.node/node_modules/imapflow/lib/imap-flow.js:307:14)
    at _socketError (/usr/local/home/.node/node_modules/imapflow/lib/imap-flow.js:643:22)
    at process.processTicksAndRejections (node:internal/process/task_queues:105:5) {
  code: 'NoConnection'
}

This says that ImapFlow.idle is the responsible culprit!
...
console.log("********* End Args *********");
			const error = new Error('Connection not available');
			error.code = 'NoConnection';
//Added this on 10/12/24. Want to catch NoConnection commands from IDLE at the top level module
...
Only required if {@link ImapFlow#disableAutoIdle} is set to `true` otherwise
IDLE is started by default on connection inactivity. NB! If `idle()` is called
manually then it does not return until IDLE is finished which means you would
have to call some other command out of scope.
